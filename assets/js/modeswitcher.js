...
// let systemInitiated = window.matchMedia("(prefers-color-scheme: light)");
...
// if (systemInitiated.matches) {
// 	changeIconImgSrc(iconMoon);
// } else {
// 	changeIconImgSrc(iconSun);
// }

// function prefersColorTest(systemInitiated) {
//   if (systemInitiated.matches) {
...
//   }
// }
// systemInitiated.addListener(prefersColorTest);
...
// 		changeIconImgSrc(iconMoon);
// 	} else if (systemInitiated.matches) {
// 		document.documentElement.setAttribute('data-theme', 'light');
// 		sessionStorage.setItem('theme', 'light');
// 		changeIconImgSrc(iconSun);
// 	} else {
